...
from podarki.models import ShopCart, ShopCartEntry
...
class SessionCart(object):
    ...
    def __iter__(self):
        ...
        products = ShopEntry.objects.filter(id__in=product_ids)
    ...
    def save_to_db(self, request):
        ...
        for product_id in self.cart.keys():
            new_entry = ShopCartEntry(
                cart=cart,
                entry=ShopEntry.objects.get(id=product_id),
